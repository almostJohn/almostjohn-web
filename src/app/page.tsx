import { NAME, ROLE } from "@/util/constants";
import Link from "next/link";

export default function HomePage() {
	return (
		<div className="mx-auto flex min-h-[calc(100vh-195px)] max-w-5xl flex-col justify-center p-6 sm:p-4">
			<h1 className="mt-12 text-6xl leading-tight font-bold sm:mt-0">
			...
			<p className="mt-6 w-full max-w-xl text-lg text-balance">
				...
				<strong>graphic designer</strong> from the <strong>Philippines</strong>.
				I love <strong>building things</strong> and{" "}
				<strong>solving problems</strong>. I enjoy{" "}
				<strong>language design</strong>,{" "}
				<strong>programming interfaces</strong>, and{" "}
				<strong>web development</strong>. I mostly use <strong>Next.js</strong>,
				a full-stack framework built on top <strong>React.js</strong>.
			</p>
